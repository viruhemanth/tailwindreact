                    ...
                    <div className="flex flex-wrap justify-center -m-1">
                        ...
                        >
                            <svg className="w-4 h-4 flex-shrink-0 mr-2" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                <path className="fill-current text-gray-400" d="M11 7H1a1 1 0 000 2h10v3l5-4-5-4v3zM8 3H1a1 1 0 010-2h7a1 1 0 010 2zM8 15H1a1 1 0 010-2h7a1 1 0 010 2z" />
                            </svg>
                            <span className="text-gray-600 dark:text-gray-300 transition duration-150 ease-in-out">View All</span>
                        </button>                            
                        <button
                            className={`font-medium px-4 py-2 bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 shadow transition duration-150 ease-in-out rounded-full inline-flex items-center justify-center m-1 ${category === '1' && 'bg-teal-500 hover:bg-teal-500 dark:bg-teal-600 dark:hover:bg-teal-600 dark:bg-opacity-25 dark:hover:bg-opacity-25'}`}
                            onClick={() => setCategory('1')}
                        >
                            <svg className="w-4 h-4 flex-shrink-0 mr-2" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                <path className={`fill-current ${category === '1' ? 'text-teal-200 dark:text-teal-400' : 'text-teal-500'}`} d="M5 16H4a4 4 0 01-4-4v-1h2v1a2 2 0 002 2h1v2zM13 10h-1.586l-1.207-1.207L14.37 4.63a2.121 2.121 0 00-3-3L7.207 5.793 5.99 4.576 5.98 3.02 3.038.079 0 3.117 3 6h1.586l1.207 1.207L4 9l3 3 1.793-1.793L10 11.414V13l3.01 3.01 2.98-2.979L13 10z" />
                            </svg>
                            <span className={`transition duration-150 ease-in-out ${category === '1' ? 'text-white dark:text-teal-400' : 'text-gray-600 dark:text-gray-300'}`}>Getting Started</span>
                        </button>
                        <button
                            className={`font-medium px-4 py-2 bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 shadow transition duration-150 ease-in-out rounded-full inline-flex items-center justify-center m-1 ${category === '2' && 'bg-purple-500 hover:bg-purple-500 dark:bg-purple-600 dark:hover:bg-purple-600 dark:bg-opacity-25 dark:hover:bg-opacity-25'}`}
                            onClick={() => setCategory('2')}
                        >
                            <svg className="w-4 h-4 flex-shrink-0 mr-2" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                <path className={`fill-current ${category === '2' ? 'text-purple-200 dark:text-purple-400' : 'text-purple-500'}`} d="M12.071 0L15 2.929v4.142L12.071 10H12V7.101L7.9 3H5v-.071L7.929 0h4.142zm-5 5L10 7.929v4.142L7.071 15H2.929L0 12.071V7.929L2.929 5h4.142z" />
                            </svg>
                            <span className={`transition duration-150 ease-in-out ${category === '2' ? 'text-white dark:text-purple-400' : 'text-gray-600 dark:text-gray-300'}`}>Layout & Design</span>
                        </button>
                        <button
                            className={`font-medium px-4 py-2 bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 shadow transition duration-150 ease-in-out rounded-full inline-flex items-center justify-center m-1 ${category === '3' && 'bg-indigo-500 hover:bg-indigo-500 dark:bg-indigo-600 dark:hover:bg-indigo-600 dark:bg-opacity-25 dark:hover:bg-opacity-25'}`}
                            onClick={() => setCategory('3')}
                        >
                            <svg className="w-4 h-4 flex-shrink-0 mr-2" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                <path className={`fill-current ${category === '3' ? 'text-indigo-200 dark:text-indigo-400' : 'text-indigo-500'}`} d="M1 0h8a1 1 0 011 1v10a1 1 0 01-1 1H1a1 1 0 01-1-1V1a1 1 0 011-1zm14.124 4.085v-.001a1 1 0 01.868 1.116l-1.243 9.932a1 1 0 01-1.117.868l-7.938-1 .248-1.988 6.946.871.995-7.938-2.007-.251.248-1.984 3 .375z" />
                            </svg>
                            <span className={`transition duration-150 ease-in-out ${category === '3' ? 'text-white dark:text-indigo-400' : 'text-gray-600 dark:text-gray-300'}`}>Templates</span>
                        </button>
                        <button
                            className={`font-medium px-4 py-2 bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 shadow transition duration-150 ease-in-out rounded-full inline-flex items-center justify-center m-1 ${category === '4' && 'bg-pink-500 hover:bg-pink-500 dark:bg-pink-600 dark:hover:bg-pink-600 dark:bg-opacity-25 dark:hover:bg-opacity-25'}`}
                            onClick={() => setCategory('4')}
                        >
                            <svg className="w-4 h-4 flex-shrink-0 mr-2" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                <path className={`fill-current ${category === '4' ? 'text-pink-200 dark:text-pink-400' : 'text-pink-500'}`} d="M13.172 5.178l-2.39-2.39 2.39-2.39C12.674.1 12.076 0 11.479 0a4.462 4.462 0 00-4.481 4.48c0 .499.1.897.199 1.395l-6.572 4.88c-.797.597-.797 1.692-.2 2.389l2.291 2.39c.697.697 1.792.597 2.39-.2l4.88-6.571c.497.1.995.199 1.493.199 2.49 0 4.48-1.992 4.48-4.481 0-.598-.099-1.195-.298-1.693l-2.49 2.39z" />
                            </svg>
                            <span className={`transition duration-150 ease-in-out ${category === '4' ? 'text-white dark:text-pink-400' : 'text-gray-600 dark:text-gray-300'}`}>Project Settings</span>
                        </button>
                    </div>
                </div>
                                ...
                                <footer className="text-sm flex items-center mt-3">
                                    <div className="flex flex-shrink-0 mr-3">
                                        <a className="relative" href="#0">
                                            ...
                                            <img className="relative rounded-full" src={require('../images/news-author-01.jpg').default} width="32" height="32" alt="Author 01" />
                                        </a>
                                    </div>
                                    <div className="text-gray-500">
                                        <span>Written by </span>
                                        <a className="font-medium text-gray-800 dark:text-gray-400 hover:underline" href="#0">Mark Varsano</a>
                                    </div>
                                </footer>
                            </div>
                        </div>
                                ...
                                <footer className="text-sm flex items-center mt-3">
                                    <div className="flex flex-shrink-0 mr-3">
                                        ...
                                        <a className="relative -ml-2" href="#0">
                                            <span className="absolute inset-0 -m-px" aria-hidden="true"><span className="absolute inset-0 -m-px bg-white dark:bg-gray-800 rounded-full"></span></span>
                                            <img className="relative rounded-full" src={require('../images/news-author-02.jpg').default} width="32" height="32" alt="Author 02" />
                                        </a>
                                    </div>
                                    <div className="text-gray-500">
                                        <span>Written by </span>
                                        <a className="font-medium text-gray-800 dark:text-gray-400 hover:underline" href="#0">Mark Varsano</a> and <a className="font-medium text-gray-800 dark:text-gray-400 hover:underline" href="#0">Elly Taylor</a>
                                    </div>
                                </footer>
                            </div>
                        </div>
                            ...
                            <div className="pl-6">
                                ...
                                <footer className="text-sm flex items-center mt-3">
                                    <div className="flex flex-shrink-0 mr-3">
                                        <a className="relative" href="#0">
                                            <span className="absolute inset-0 -m-px" aria-hidden="true"><span className="absolute inset-0 -m-px bg-white dark:bg-gray-800 rounded-full"></span></span>
                                            <img className="relative rounded-full" src={require('../images/news-author-03.jpg').default} width="32" height="32" alt="Author 03" />
                                        </a>
                                    </div>
                                    <div className="text-gray-500">
                                        <span>Written by </span>
                                        <a className="font-medium text-gray-800 dark:text-gray-400 hover:underline" href="#0">Lisa Allison</a>
                                    </div>
                                </footer>
                            </div>
                        </div>
                        ...
                        <div className="flex pr-6 py-5 bg-white dark:bg-gray-800 divide-x divide-gray-200 dark:divide-gray-700 shadow-2xl">
                            ...
                            <div className="pl-6">
                                ...
                                <footer className="text-sm flex items-center mt-3">
                                    ...
                                    <div className="text-gray-500">
                                        <span>Written by </span>
                                        <a className="font-medium text-gray-800 dark:text-gray-400 hover:underline" href="#0">Mary Champ</a>
                                    </div>
                                </footer>
                            </div>
                        </div>
                    ...
                    <article className={`mb-2 ${!['', '4'].includes(category) && 'hidden'}`}>
                        <div className="flex pr-6 py-5 bg-white dark:bg-gray-800 divide-x divide-gray-200 dark:divide-gray-700 shadow-2xl">
                            ...
                            <div className="pl-6">
                                ...
                                <p className="text-gray-600 dark:text-gray-400">Et leo duis ut diam quam nulla porttitor porttitor lacus luctus accumsan tortor, lorem dolor sed viverra ipsum nunc aliquet bibendum enim eu.</p>
                                <footer className="text-sm flex items-center mt-3">
                                    <div className="flex flex-shrink-0 mr-3">
                                        <a className="relative" href="#0">
                                            <span className="absolute inset-0 -m-px" aria-hidden="true"><span className="absolute inset-0 -m-px bg-white dark:bg-gray-800 rounded-full"></span></span>
                                            <img className="relative rounded-full" src={require('../images/news-author-05.jpg').default} width="32" height="32" alt="Author 05" />
                                        </a>
                                    </div>
                                    <div className="text-gray-500">
                                        <span>Written by </span>
                                        <a className="font-medium text-gray-800 dark:text-gray-400 hover:underline" href="#0">Yuri Lapko</a>
                                    </div>
                                </footer>
                            </div>
                        </div>
